...
const FeatureContainer1: FunctionComponent<FeatureContainer1Type> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-row items-center justify-center gap-[10px] max-w-full mq450:gap-[27px] mq750:gap-[55px] mq1125:flex-wrap px-16 py-12 mq1125:px-0 mq1125:py-0">
        <div className="h-full w-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-11xl bg-white mq1125:hidden" />

        <div className="w-full max-w-[637px] flex flex-col items-center justify-center mq750:min-w-full mq1100:flex-1 mq1125:hidden">
          <div className="self-stretch h-[402px] relative -top-32">
            <Map />
          </div>
        </div>
        <div className="flex-1 flex flex-col items-start justify-start gap-3.5  mq750:min-w-full ">
          ...
          <div className="self-stretch h-[30rem] mq560:h-[20rem] mq560:-top-36 mq450:h-[15rem] mq450:-top-48 relative -top-20 mq1125:block hidden">
            <Map />
          </div>
          <div className="mq1125:mt-4 mq800:w-[96%] self-stretch flex flex-row  items-start justify-start gap-2 w-full max-w-full text-5xl mq750:flex-wrap mq800:mt-4">
            <div className="flex-1 flex flex-col items-start justify-start gap-7 min-w-[383px] max-w-full mq800:min-w-[50%]">
              ...
              <div className="relative text-xs text-color-3">
