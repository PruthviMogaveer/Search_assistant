...
const FeatureContainer1: FunctionComponent<FeatureContainer1Type> = ({
  ...
  return (
    <section
    className={` mq1125:-mt-32 mq800:-mt-2 self-stretch flex flex-row items-center justify-center  max-w-full  text-13xl text-color-2 font-heading-text-inter-semi-bold-24 pt-0 px-[70px] mq1325:px-16 mq800:px-6  pb-[49px] box-border mq750:pb-8 mq750:box-border ${className}`}
  >

    <div className="relative flex flex-row items-start justify-center gap-[110px] max-w-full mq450:gap-[27px] mq750:gap-[55px] mq1125:flex-wrap px-24 py-12 mq1125:px-0 mq1125:py-0">
      ...
      <div className="flex flex-col items-start justify-end pt-0 px-0 pb-1.5 box-border min-w-[537px] max-w-full mq750:min-w-full mq1100:flex-1">
        <div className="self-stretch h-[402px] relative mq1125:hidden">
          <img
